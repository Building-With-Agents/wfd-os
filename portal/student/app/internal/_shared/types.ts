...
export interface VerdictPayload {
  ...
  headline: string
  body: string
  // Optional provenance for the verdict text. Set by the Audit Readiness
  // tab's LLM verdict path (see audit_readiness_tab_spec.md §v1.2.8):
  //   "llm"              — freshly generated by the Gemini call.
  //   "cache"            — served from the 5-minute verdict cache.
  //   "static_fallback"  — engine unreachable or LLM call failed.
  // Other tabs (Budget, Placements) don't set this field — the UI
  // treats the absence as no-info and renders the verdict normally.
  source?: "llm" | "cache" | "static_fallback"
}
