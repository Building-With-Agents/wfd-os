...
import CaseStudyFilter from "./filter"

export default function CaseStudiesIndex() {
  const studies = getContentByType("case-studies")
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-gradient-to-b from-green-500/5 to-background px-4 py-16">
        <div className="mx-auto max-w-6xl">
          ...
          <h1 className="text-3xl font-bold text-foreground sm:text-4xl">Case Studies</h1>
          <p className="mt-2 text-muted-foreground">Real outcomes from organizations using agentic AI to solve operational problems.</p>
        </div>
      </section>

      <CaseStudyFilter studies={JSON.parse(JSON.stringify(studies))} />
    </div>
  )
}
