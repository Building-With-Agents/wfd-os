...
export default function TalentShowcase({ initialData }: { initialData?: InitialData }) {
  ...
  }, [loadFilters, loadCandidates, initialData])
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Header with top-level nav — AI Consulting first, consistent across portal */}
      <header className="border-b border-border bg-card">
        <div className="mx-auto max-w-7xl px-4 py-5 sm:px-6 lg:px-8">
          ...
          <div className="mt-3 text-right hidden sm:block">
            <div className="text-xs text-muted-foreground">Washington Tech Workforce Coalition &middot; Powered by Computing for All</div>
          </div>
